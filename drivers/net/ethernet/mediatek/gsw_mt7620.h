...
struct mtk_eth_cb {
	u32 (*mtk_mdio_read)(struct mtk_eth *, int, int);
	u32 (*mtk_mdio_write)(struct mtk_eth *, u32, u32, u32);
	void (*mtk_w32)(struct mtk_eth *, u32, unsigned);
	u32 (*mtk_r32)(struct mtk_eth *, unsigned);
};

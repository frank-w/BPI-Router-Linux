...
static struct mtk_mux infra_muxes[] = {
	...
	MUX_CLR_SET(CLK_INFRA_MUX_SPI2_BCK_SEL, "infra_mux_spi2_bck_sel",
		    infra_mux_spi2_bck_parents, 0x0018, 0x0010, 0x0014, 6, 1),
	MUX_CLR_SET(CLK_INFRA_PWM_BCK_SEL, "infra_pwm_bck_sel",
	...
	MUX_CLR_SET(CLK_INFRA_PCIE_GFMUX_TL_O_P0_SEL,
		    ...
		    infra_pcie_gfmux_tl_ck_o_p0_parents, 0x0028, 0x0020,
		    0x0024, 0, 2),
	MUX_CLR_SET(CLK_INFRA_PCIE_GFMUX_TL_O_P1_SEL,
		    "infra_pcie_gfmux_tl_ck_o_p1_sel",
		    infra_pcie_gfmux_tl_ck_o_p1_parents, 0x0028, 0x0020,
		    0x0024, 2, 2),
};

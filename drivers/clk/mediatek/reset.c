				    ...
				    unsigned long id, bool deassert)
{
	...
	printk(KERN_ALERT "DEBUG: Passed %s %d base:0x%llx array-offset:0x%lx=0x%x bit:%ld\n",__FUNCTION__,__LINE__,
				regmap_get_base(data->regmap),id / RST_NR_PER_BANK,(unsigned int)data->desc->rst_bank_ofs[id / RST_NR_PER_BANK],id % RST_NR_PER_BANK);

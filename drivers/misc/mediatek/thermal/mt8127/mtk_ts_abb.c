...
static int mtktsabb_get_temp(struct thermal_zone_device *thermal, int *t)
{
...
static int mtktsabb_get_crit_temp(struct thermal_zone_device *thermal, int *temperature)
{

...
static const struct pinfunction mt7987_functions[] = {
	PINCTRL_PIN_FUNCTION("wdt", mt7987_wdt),
	PINCTRL_PIN_FUNCTION("jtag", mt7987_jtag),
	PINCTRL_PIN_FUNCTION("pcm", mt7987_pcm),
	PINCTRL_PIN_FUNCTION("uart", mt7987_uart),
	PINCTRL_PIN_FUNCTION("pwm", mt7987_pwm),
	PINCTRL_PIN_FUNCTION("usb", mt7987_usb),
	PINCTRL_PIN_FUNCTION("led", mt7987_led),
	PINCTRL_PIN_FUNCTION("eth", mt7987_ethernet),
	PINCTRL_PIN_FUNCTION("spi", mt7987_spi),
	PINCTRL_PIN_FUNCTION("flash", mt7987_flash),
	PINCTRL_PIN_FUNCTION("i2c", mt7987_i2c),
	PINCTRL_PIN_FUNCTION("pcie", mt7987_pcie),
	PINCTRL_PIN_FUNCTION("i2s", mt7987_i2s),
};
